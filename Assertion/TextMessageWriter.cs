...
namespace TestMonkey.Assertion
{
    ...
    public class TextMessageWriter : MessageWriter
    {
        ...
        /// <summary>
        ///     Prefix used for the internalActual value line of a message
        /// </summary>
        ...
        ///     the display of internalActual and expected values than is provided
        ///     by the default implementation.
        /// </summary>
        /// <param name="expected">The expected value</param>
        /// <param name="actual">The internalActual value causing the failure</param>
        ...
        /// <summary>
        ///     Display the expected and internalActual string values on separate lines.
        ///     If the mismatch parameter is >=0, an additional line is displayed
        ///     line containing a caret that points to the mismatch point.
        /// </summary>
        /// <param name="expected">The expected string value</param>
        /// <param name="actual">The internalActual string value</param>
                                                      ...
                                                      bool clipping)
        {
            ...
            WriteLine();
            WriteActualLine(actual);
            //DisplayDifferences(expected, internalActual);
            if (mismatch >= 0)
        ...
        /// <summary>
        ///     Writes the text for an internalActual value.
        /// </summary>
        ...
        /// </summary>
        /// <param name="constraint">The constraint for which the internalActual value is to be written</param>
        ...
        /// </summary>
        /// <param name="actual">The internalActual value causing a failure</param>
