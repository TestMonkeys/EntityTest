...
{
    /// <summary>
    ///     Delegate used to delay evaluation of the internalActual value
    ...
    public abstract class Constraint : IResolveConstraint
    {
        ...
        ///     that fail to set the internalActual value in their
        ///     Matches override.
        /// </summary>
        ...
        ///     failing to set the internalActual value.
        /// </summary>
        protected static object UNSET = new UnsetObject();

        /// <summary>
        ///     The internalActual value being tested against a constraint
        /// </summary>
        protected object internalActual = UNSET;
        ...
        /// </summary>
        /// <param name="del">
        ///     An <see cref="ActualValueDelegate{T}" />
        /// </param>
        /// <returns>True for success, false for failure</returns>
    ...
    /// <returns>True for success, false for failure</returns>
...
#else
		public virtual bool Matches(ref bool internalActual)
#endif
        {
            return Matches(internalActual);
        }
        ...
        {
            IResolveConstraint l = left;
            IResolveConstraint r = right;
        ...
        {
            IResolveConstraint r = constraint;
