...
namespace TestMonkey.Assertion.Constraints
{
    ...
    public abstract class PathConstraint : Constraint
    {
        ...
        public override bool Matches(object actual)
        {
            ...
            var actualPath = actual as string;

            return actualPath != null && IsMatch(expectedPath, actualPath);
        }

        /// <summary>
        ///     Returns true if the expected path and internalActual path match
        /// </summary>
        ...
        {
            return string.Format("<{0} \"{1}\" {2}>", DisplayName, expectedPath,
                                 caseInsensitive ? "ignorecase" : "respectcase");
        }
