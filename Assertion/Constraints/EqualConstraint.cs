...
{
    /// <summary>
    ///     EqualConstraint is able to compare an internalActual value with the
    ...
    public class EqualConstraint : Constraint
    {
        ...
        /// </summary>
        private readonly TestThatEqualityComparer comparer = new TestThatEqualityComparer();
        ...
        /// <summary>
        ///     Switches the .Within() modifier to interpret its tolerance as
        ///     a percentage that the internalActual values is allowed to deviate from
        ///     the expected value.
        /// </summary>
        /// <returns>Self</returns>
        ...
        {
            DisplayDifferences(writer, expected, internalActual, 0);
        }
        ...
        private void DisplayStreamDifferences(MessageWriter writer, Stream expected, Stream actual, int depth)
        {
            if (expected.Length == actual.Length)
            {
                FailurePoint fp = comparer.FailurePoints[depth];
        ...
        /// <param name="actual">The internalActual collection</param>
                                                  ...
                                                  int depth)
        {
            ...
            {
                FailurePoint failurePoint = comparer.FailurePoints[depth];
        ...
        ///     and internalActual enumerations, collections or arrays. If both are identical,
        ///     the value is only shown once.
        /// </summary>
        /// <param name="writer">The MessageWriter on which to display</param>
        /// <param name="expected">The expected collection or array</param>
        /// <param name="actual">The internalActual collection or array</param>
        ...
        /// <summary>
        ///     Displays a single line showing the point in the expected and internalActual
        ///     arrays at which the comparison failed. If the arrays have different
        ///     structures or dimensions, both values are shown.
        /// </summary>
        /// <param name="writer">The MessageWriter on which to display</param>
        /// <param name="expected">The expected array</param>
        /// <param name="actual">The internalActual array</param>
        ...
        /// <param name="actual">The internalActual enumeration</param>
        /// <param name="depth">The depth of this failure in a set of nested collections</param>
                                                  ...
                                                  int depth)
        {
            ...
            if (comparer.FailurePoints.Count > depth)
            {
                ...
                //{
                //    writer.Write("  Extra:    ");
                //    writer.WriteCollectionElements(internalActual, failurePoint.Position, 3);
                //}
                //else
                //{
                //    writer.Write("  Missing:  ");
