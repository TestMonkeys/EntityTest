...
using TestMonkey.Assertion.Interfaces;
...
namespace TestMonkey.Assertion.Constraints
{
    ...
    /// </summary>
    public class TestThatEqualityComparer : INUnitEqualityComparer
    {
        ...
        /// </summary>
        private readonly EqualityAdapterList externalComparers = new EqualityAdapterList();
        ...
        /// </summary>
        public static TestThatEqualityComparer Default
        {
            get { return new TestThatEqualityComparer(); }
        }
        ...
        {
            foreach (var adapter in externalComparers)
        ...
        private bool ArraysEqual(Array expected, Array actual, ref Tolerance tolerance)
        {
            ...
            return EnumerablesEqual(expected, actual, ref tolerance);
        }
        ...
        private bool StreamsEqual(Stream expected, Stream actual)
        {
            ...
            var bufferExpected = new byte[BUFFER_SIZE];
            var bufferActual = new byte[BUFFER_SIZE];

            var binaryReaderExpected = new BinaryReader(expected);
            var binaryReaderActual = new BinaryReader(actual);
        ...
        {
#if CLR_2_0 || CLR_4_0
            private readonly Dictionary<UnorderedReferencePair, object> table =
                new Dictionary<UnorderedReferencePair, object>();
#else
...
#if CLR_2_0 || CLR_4_0
            private class UnorderedReferencePair : IEquatable<UnorderedReferencePair>
#else
