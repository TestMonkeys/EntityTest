...
namespace TestMonkey.Assertion.Constraints
{
    ...
    public class MsgUtils
    {
        ...
        /// <summary>
        ///     Clip the expected and internalActual strings in a coordinated fashion,
        ...
        public static void ClipExpectedAndActual(ref string expected, ref string actual, int maxDisplayLength,
                                                 int mismatch)
        {
        ...
        /// <param name="actual">The internalActual string</param>
