...
namespace TestMonkey.Assertion
{
    ...
    public class Assert
    {
        ...
        /// </summary>
        /// <param name="message">
        ///     The message to initialize the <see cref="InconclusiveException" /> with.
        /// </param>
        /// <param name="args">Arguments to be used in formatting the message</param>
        ...
        public static void That(object actual, IResolveConstraint expression, string message, params object[] args)
        {
            ...
            if (!constraint.Matches(actual))
            {
                ...
                throw new AssertionFailedException(writer.ToString());
            }
        }
    ...
    /// <param name="constraint">A Constraint to be applied</param>
        static public void That(ref bool internalActual, IResolveConstraint constraint)
        {
            Assert.That(ref internalActual, constraint.Resolve(), null, null);
        }
        ...
        /// <param name="constraint">A Constraint to be applied</param>
        /// <param name="message">The message that will be displayed on failure</param>
        static public void That(ref bool internalActual, IResolveConstraint constraint, string message)
        {
            Assert.That(ref internalActual, constraint.Resolve(), message, null);
        }
    ...
    /// <param name="expr">A Constraint expression to be applied</param>
        ...
        ///     the expected and the internalActual
        /// </param>
        /// <param name="message">The message to display in case of failure</param>
        /// <param name="args">Array of objects to be used in formatting the message</param>
        ...
        /// <param name="actual">The internalActual object</param>
        /// <param name="message">The message to display in case of failure</param>
        /// <param name="args">Array of objects to be used in formatting the message</param>
        ...
        /// <summary>
        ///     Helper for Assert.AreEqual(double expected, double internalActual, ...)
